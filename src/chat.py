...
class Chat:
    ...
    def get_user_list_message(self) -> bytes:
        ...
        return constants.to_bytes_message_type(ChatMessageType.USER_LIST) + user_id_list_bytes

    def get_introduce_user_message(self, user_id: bytes) -> bytes:
        return constants.to_bytes_message_type(ChatMessageType.INTRODUCE_USER) + user_id

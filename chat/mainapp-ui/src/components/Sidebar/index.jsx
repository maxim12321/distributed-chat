  ...
  return (
      <div className="chat__sidebar">
        <div className="chat__sidebar-header">
          ...
          <img className="chat__sidebar-header-add" src={plus_dialog} alt = "plus_dialog" onClick={() => setVisible(true)}/>
        </div>
        <div className="chat__sidebar-dialogs">
          <Dialogs  />
        </div>
        <Modal className="chat__sidebar-modal" title="Создать диалог" visible={visible} onOk={onClose} onCancel={onClose}>
        <input
